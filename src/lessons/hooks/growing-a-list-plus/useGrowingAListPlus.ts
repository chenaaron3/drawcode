...
import content from "./growing-a-list-plus.md?raw";
...
export function useGrowingAListPlus(lessonId: string) {
    ...
    startLesson(lessonId, content, [
      {
        ...
        description: "Jiho is updating a list of orders. He just received orders for 'lilac' and 'iris'. Create a list called new_orders that contains our new orders.",
      },
      {
        id: "combine-orders",
        title: "Combine Orders",
        description: "Use + to create a new list called orders_combined that combines orders with new_orders.",
      },
      {
        id: "fix-broken-prices",
        title: "Fix Broken Prices",
        description: "Remove the # and whitespace in front of the list broken_prices. Fix the command by inserting brackets ([ and ]) so that it will run without errors.",
      },
    ]);
  ...
  }, [lessonId, currentTask, task1Complete, task2Complete, task3Complete]);
}