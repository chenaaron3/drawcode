...
import content from "./string-concatenation.md?raw";
    ...
    startLesson(lessonId, content, [
      {
        ...
        description: "Concatenate the strings and save the message they form in the variable message. Now uncomment the print statement and run your code to see the result in the terminal!",
      },
    ]);
